...
export const joinRoom = (roomIdOrData) => {
  const data = typeof roomIdOrData === 'number'
    ? { room_id: roomIdOrData }
    : roomIdOrData;
  return axiosClient.post("/rooms/join/", data);
};
...
export const leaveRoom = (roomIdOrData) => {
  const data = typeof roomIdOrData === 'number'
    ? { room_id: roomIdOrData }
    : roomIdOrData;
  return axiosClient.post("/rooms/leave/", data);
};
